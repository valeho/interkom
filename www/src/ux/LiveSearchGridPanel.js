...
Ext.define('Ext.ux.LiveSearchGridPanel', {
    ...
    defaultStatusText: 'Ни чего не найдено',
    ...
    onTextFieldChange: function () {
        ...
        if (me.searchValue !== null) {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://localhost/ci/product/actionAjaxSearch',
                data: {title: me.searchValue},
                dataType: 'json',
                success: function (data) {
                    if (data.status == 1) {
                        me.getStore().loadData(data.name);
