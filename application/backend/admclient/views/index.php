    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 text-right">
                <a href="<?php echo site_url(); ?>admclient/create" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-plus"></i> Добавить запись</a>
            </div>
        </div>
        <p></p>
        <div class="row">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" style="right: 0;left:-116px">
                                            <li><a href="<?php echo site_url(); ?>admclient/edit/<?php echo $itemContent->id; ?>">Редактировать</a></li>
...
<script>
    ...
    function deleteRecord()
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url(); ?>admclient/delete',
            data: data,
            dataType: 'json',
