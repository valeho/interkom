        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><b>Ссылка*</b></td><td><input type="text" name="link" value="<?= $link ?>" class="form-control input-sm"></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="row">
                                <div class="col-lg-12"><b>Фото:</b>
                                    <div class="input-group">
                                        <input type="text" name="photo" class="form-control input-sm" id="photo" value="<?php echo $photo; ?>">
                                        <span class="input-group-btn">
                                            <input type="button" href="javascript:;" onclick="moxman.browse({view: 'thumbs', fields: 'photo', extensions: 'jpg,gif,png', convert_urls: true, relative_urls: false, remove_script_host: true});" class="btn btn-sm btn-primary" value="Прикрепить фото">
                                        </span>
                                    </div>
                                </div>
                            </div>
