...
class Ion_auth
{
    ...
    public function is_moder($id = false)
    {
        $this->ion_auth_model->trigger_events('is_moder');

        $moder_group = $this->config->item('moder_group', 'ion_auth');

        return $this->in_group($moder_group, $id);
    }
    ...
    public function is_adminmins($id = false)
    {
        $this->ion_auth_model->trigger_events('is_adminmins');

        $default_group = $this->config->item('second_group', 'ion_auth');
