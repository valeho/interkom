...
class Image_moo
{
	...
	public function crop($x1, $y1, $x2, $y2, $w, $h)
	//----------------------------------------------------------------------------------------------------------
	...
	//----------------------------------------------------------------------------------------------------------
	{
		...
		imagecopy($this->temp_image, $this->main_image, 0, 0, $x1, $y1, $w, $h);
        //imagecopyresampled($this->temp_image, $this->main_image,0,0,$x1,$y2,
         // $w,$h,$w,$h);
